...
<body>
    <div class="container-fluid">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="practice.php" title="Les ateliers pratiques">Nos ateliers</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="tuto.php" title="Les gestes écologiques">Les écos-gestes</a>
                            </li>
                            <li class="nav-item">
        ...
        <?php
            $article = 'SELECT * FROM article WHERE category_id=3 ORDER BY date DESC;';
